    ...
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div className="">
          ...
          <label className='text-gray-500 cursor-pointer ml-2' htmlFor='storeData'>Save my email and my name for my future comments</label>
        </div>
      </div>
      {error && <p className='text-xs text-red-500'>All fields are requiered !</p>}
      <div className="mt-8">
        ...
        {setShowSuccessMessage && <span className='text-xl float-right font-semibold mt-3 text-green-500'>Comment submitted for review</span>}
      </div>
    </div>
  )
}
